// functions for exponentially correlated colored noise
// based on Fox, Gatland, Roy, and Vemuri, PRA 38, 5938 (1988)
// Takes white noise and converts it to Gaussian noise via Box-Mueller 
// and then integrating the Ornstein-Uhlenbeck equations.
